...
const StyledInsectBites = styled.main``
...
export const query = graphql`
  query InsectBites {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: { eq: "/newport-beach-ca/minor-injuries/insect-bites/" }
      }
    ) {
      pageTitleData: data {
        Page_Title
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Insect Bites" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
