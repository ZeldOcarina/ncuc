...
const StyledAllergiesAndAllergicReactions = styled.main``

const AllergiesAndAllergicReactions = ({
  data: {
  ...
  return (
    <Layout>
      ...
      />
      <StyledAllergiesAndAllergicReactions>
...
export const query = graphql`
  query AllergiesAndAllergicReactions {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: {
          eq: "/newport-beach-ca/minor-illnesses/allergies-and-allergic-reactions/"
        }
      }
    ) {
      pageTitleData: data {
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Allergies and Allergic Reactions" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
    ...
    heroData: airtable(
      table: { eq: "Allergies and Allergic Reactions" }
      data: { Block: { eq: "Hero" } }
    ) {
      heroData: data {
        Heading
...
export default AllergiesAndAllergicReactions
