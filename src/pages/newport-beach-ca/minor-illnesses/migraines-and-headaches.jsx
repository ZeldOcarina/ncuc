...
const StyledMigrainesAndHeadaches = styled.main``

const MigrainesAndHeadaches = ({
  data: {
...
export const query = graphql`
  query MigrainesAndHeadaches {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: {
          eq: "/newport-beach-ca/minor-illnesses/migraines-and-headaches/"
        }
      }
    ) {
      pageTitleData: data {
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Migraines and Headaches" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
    ...
    heroData: airtable(
      table: { eq: "Migraines and Headaches" }
      data: { Block: { eq: "Hero" } }
    ) {
      heroData: data {
        Heading
...
export default MigrainesAndHeadaches
