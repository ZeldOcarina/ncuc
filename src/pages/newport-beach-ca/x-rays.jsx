...
export const query = graphql`
  query XRays {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: { Permalink: { eq: "/newport-beach-ca/x-rays/" } }
    ) {
      pageTitleData: data {
        Page_Title
      }
    ...
    faqsData: allAirtable(
      filter: { table: { eq: "Xrays" }, data: { Block: { eq: "FaqItem" } } }
    ) {
      faqsData: nodes {
        data {
          Heading
    ...
    cardsData: allAirtable(
      filter: { table: { eq: "Xrays" }, data: { Block: { eq: "CardsItem" } } }
    ) {
      cardsData: nodes {
        data {
          Heading
