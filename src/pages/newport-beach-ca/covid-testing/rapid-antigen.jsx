...
const StyledRapidAntigen = styled.main``
...
export const query = graphql`
  query RapidAntigen {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: { eq: "/newport-beach-ca/covid-testing/rapid-antigen/" }
      }
    ) {
      pageTitleData: data {
        Page_Title
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Rapid Antigen" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
    ...
    heroData: airtable(
      table: { eq: "Rapid Antigen Covid Testing" }
      data: { Block: { eq: "Hero" } }
    ) {
      heroData: data {
        Heading
