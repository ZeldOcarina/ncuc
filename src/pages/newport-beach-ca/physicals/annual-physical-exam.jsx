...
const StyledAnnualPhysicalExam = styled.main``

const AnnualPhysicalExam = ({
  data: {
...
export const query = graphql`
  query AnnualPhysicalExam {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: { eq: "/newport-beach-ca/physicals/annual-physical-exam/" }
      }
    ) {
      pageTitleData: data {
        Page_Title
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Annual Physical Exam" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
