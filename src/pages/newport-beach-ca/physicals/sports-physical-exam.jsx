...
const StyledSchoolPhysicalExam = styled.main``

const SportsPhysicalExam = ({
  data: {
...
export const query = graphql`
  query SportsPhysicalExam {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: { eq: "/newport-beach-ca/physicals/school-physical-exam/" }
      }
    ) {
      pageTitleData: data {
        Page_Title
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Sports Physical Exam" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
...
export default SportsPhysicalExam
