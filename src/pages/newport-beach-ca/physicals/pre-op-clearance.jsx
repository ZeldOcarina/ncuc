...
const StyledPreOpClearance = styled.main``

const PreOpClearance = ({
  data: {
...
export const query = graphql`
  query PreOpClearance {
    pageTitleData: airtable(
      table: { eq: "Sitemap" }
      data: {
        Permalink: { eq: "/newport-beach-ca/physicals/pre-op-clearance/" }
      }
    ) {
      pageTitleData: data {
        Page_Title
    ...
    keywordsData: airtable(
      table: { eq: "Sitemap" }
      data: { Page_Title: { eq: "Pre Op Clearance" } }
    ) {
      keywordsData: data {
        Main_Keyword
        Relative_Keywords
